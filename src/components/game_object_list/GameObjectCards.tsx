    ...
    return (
        <Card css={{ ml: "10%", mw: "200px" }} isPressable variant={"bordered"}>
            <Row>
                {icon}
                <Spacer x={0.2} />
                <Text b>{props.componentName}</Text>
            </Row>
        </Card>
    );
}
            ...
            <Container css={{ ml: "5%" }}>
                <Card css={{ mw: "200px" }} isPressable variant={"bordered"}>
                    <Row>
                        ...
                        />
                        <Spacer x={0.2} />
                        <Text b>Component 1</Text>
                    </Row>
                </Card>
                <Spacer y={0.2} />
                <Comp
                    componentDataType={ComponentDataType.FIELD}
                    componentName={"Field"}
                />
                <Comp
                    componentDataType={ComponentDataType.METHOD}
                    componentName={"Method"}
                />
                <Comp
                    componentDataType={ComponentDataType.PROPERTY}
                    componentName={"Property"}
                />
                <Comp
                    componentDataType={ComponentDataType.ACTION}
        ...
        <Container>
            <Card css={{ mw: "200px" }} isPressable variant={"bordered"}>
                <Row>
                    ...
                    />
                    <Spacer x={0.2} />
                    <Text b>GameObject {props.name}</Text>
                </Row>
            </Card>
            <Spacer y={0.2} />
            <ComponentCard />
